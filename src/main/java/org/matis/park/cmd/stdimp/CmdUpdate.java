...
public class CmdUpdate extends Cmd {
    ...
    /**
     * <p>Updates existing parking. Get a parking object from the post data and calls {@link org.matis.park.dao.ParkingDao#update(org.matis.park.modelobj.IParking)}</p>
     * @param httpExchange
     * @throws IOException
     */
